 ...
 * @param {Uint32Array} a_col_ptr
 * @param {Uint32Array} a_row_idx
 * @param {Float64Array} a_values
 * @param {Float64Array} b
 * @param {number} n
 * @param {number} m
 * @param {string} cone_spec_json
 * @param {string} settings_json
 * @returns {any}
 */
function solve(p_col_ptr, p_row_idx, p_values, q, a_col_ptr, a_row_idx, a_values, b, n, m, cone_spec_json, settings_json) {
    const ptr0 = passArray32ToWasm0(p_col_ptr, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray32ToWasm0(p_row_idx, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArrayF64ToWasm0(p_values, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passArrayF64ToWasm0(q, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ptr4 = passArray32ToWasm0(a_col_ptr, wasm.__wbindgen_malloc);
    const len4 = WASM_VECTOR_LEN;
    const ptr5 = passArray32ToWasm0(a_row_idx, wasm.__wbindgen_malloc);
    const len5 = WASM_VECTOR_LEN;
    const ptr6 = passArrayF64ToWasm0(a_values, wasm.__wbindgen_malloc);
    const len6 = WASM_VECTOR_LEN;
    const ptr7 = passArrayF64ToWasm0(b, wasm.__wbindgen_malloc);
    const len7 = WASM_VECTOR_LEN;
    const ptr8 = passStringToWasm0(cone_spec_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len8 = WASM_VECTOR_LEN;
    const ptr9 = passStringToWasm0(settings_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len9 = WASM_VECTOR_LEN;
    const ret = wasm.solve(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, ptr6, len6, ptr7, len7, n, m, ptr8, len8, ptr9, len9);
    return ret;
}
exports.solve = solve;
...
const wasmPath = `${__dirname}/clarabel_wasm_bg.wasm`;
